...
server <- function(input, output) {
  ...
  #______________________________________________________________________________________________  
    ...
    output$overall_time_plot <- renderPlot({
   ...
   output$state_plot <- renderPlot({
     ...
     ggplot() +
       geom_line(aes(x=date, y=state_cases,color="Confirmed Cases"),data = state_confirmed_deaths) +
       geom_line(aes(x=date, y=state_deaths,color="Deaths"),data = state_confirmed_deaths) +
   ...
   #______________________________________________________________________________________________ 
   output$fluctuation_plot<- renderPlot({
